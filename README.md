...
python -m data_gen.qwen_annotator annotate --images path/to/real_images --output data/annotated/labels.jsonl
...
| 模块 | 技术 |
|------|------|
| 数据生成 | Python, matplotlib, LaTeX, Qwen3-VL-4B-Instruct (Transformers) |
